 ...
 * Edited as necessary for Truth Table Enumeration
 */
...
public class KB {
	...
	protected List<Sentence>sentencesAll = new ArrayList();
	...
	public void addAll(Sentence s) { // Second list of Sentences for ALL sentences, not just those in a "knowledge base"
		sentencesAll.add(s);
	}
