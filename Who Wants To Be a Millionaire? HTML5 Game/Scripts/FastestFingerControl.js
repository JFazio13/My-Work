...
function revealFastestFingerAnswersinCorrectOrder(){
	...
	$(targetId).transition({perspective:0,'left':'-20px'}, 350, 'linear');
...
function showTheFastestFingerWinner(){
	...
	$('#fastestContestant .fastestContestantTimeP').html(window.GameVariables.FastestFingerContestantTimes[window.GameVariables.FastestFingerConstestantWinner - 1] + 's');
